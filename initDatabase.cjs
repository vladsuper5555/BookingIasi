      ...
      await queryAsync(conDB, createTableSql1);
          ...
          let hotelData = [
            ['BookingIasi/images/Unirea', 
              ...
              'Hotel 4 stars' , 
              'Unirea Hotel & Spa', 
              'Offers features such as indoor swimming pool, free parking, free WiFi, spa and wellness centre, airport shuttle, family rooms. It has 2 restaurants, you can find a tea/coffee maker in all rooms and bar.',
              '14:00',
              '12:00',
              ...
              'Hotel',
              'Prestige Hotel', 
              'Offers features such as air conditioning, private bathroom and shower cabins, fridge, modern furniture, internet connection.', 
              '14:00', 
              '07:00',
