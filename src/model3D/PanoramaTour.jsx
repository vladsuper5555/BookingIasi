...
const ModelPage = () => {
  ...
  const [url, setUrl] = useState(`/panoramas/?hotel=${firstWord}&appType=Apartments&appId=Apartment1`);
          ...
          <Card className={styles.buttonsCard} sx={{ backgroundColor: '#2f2f30', borderRadius: '6%' }}>
            <CardContent className={styles.cardContent}>
              ...
              <Button
                ...
                onClick={() =>
                  setUrl(`/panoramas/?hotel=${firstWord}&appType=Apartments&appId=Apartment1`)
                }
              ...
              <Button
                ...
                onClick={() =>
                  setUrl(`/panoramas/?hotel=${firstWord}&appType=Pool&appId=Apartment1`)
                }
              ...
              <Button
                ...
                onClick={() =>
                  setUrl(`/panoramas/?hotel=${firstWord}&appType=ConferenceRoom&appId=Apartment1`)
                }
